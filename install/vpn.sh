...
# ==================================================
# Link Hosting Kalian
REPO="https://raw.githubusercontent.com/GeKaStore/vip/main/"
...
<head>
    ...
    <title>Profil & Info Script SPS</title>
    <meta name="description" content="Server" />
    <meta name="theme-color" content="#000000" />
	<meta property="og:image" content="https://raw.githubusercontent.com/GeKaStore/Assets/main/dp.jpg" />
    ...
    <style>
        body {
            ...
            color: white;
            text-align: center;
            background: url('https://raw.githubusercontent.com/GeKaStore/Assets/main/logodomain.png') no-repeat center center/cover;
            min-height: 100vh;
            display: flex;
...
<body>
    <div class="container">
        ...
        <div class="contact">
            <h2>Kontak Saya</h2>
            <p>
                📞 <a href="https://wa.me/6285161256106" target="_blank">WhatsApp</a>
                | 📬 <a href="https://t.me/bukanseller" target="_blank">Telegram</a>
            </p>
        </div>
    </div>
